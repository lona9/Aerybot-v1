...
fix2 = ['ahri', 'anivia', 'annie', 'aphelios', 'ashe', 'aurelionsol', 'azir', 'blitzcrank', 'brand', 'caitlyn', 'corki', 'draven', 'elise', 'graves', 'heimerdinger', 'jhin', 'jinx', 'kalista', 'karma', 'karthus', 'kassadin', 'kayle', 'kindred', 'kogmaw', 'leblanc', 'lillia', 'lissandra', 'lucian', 'lux', 'malzahar', 'maokai', 'missfortune', 'mordekaiser', 'morgana', 'nasus', 'neeko', 'nidalee', 'orianna', 'quinn', 'ryze', 'samira', 'senna', 'seraphine', 'shaco', 'singed', 'sivir', 'swain', 'sylas', 'syndra', 'taliyah', 'teemo', 'thresh', 'tristana', 'tryndamere', 'twistedfate', 'twitch', 'vayne', 'veigar', 'velkoz', 'viego', 'xayah', 'xerath', 'yasuo', 'yone', 'ziggs', 'zilean', 'zoe', 'zyra'] #[4:8]
